...
const ImageFileUpload = ({ setParentState, currentImg }: hallData) => {
  ...
  //       // If it's a URL string from Dataverse
  //       setSelectedImage(currentImg);
  //     } else if (currentImg instanceof File) {
  //       // If it's a File object, create a temporary preview URL
